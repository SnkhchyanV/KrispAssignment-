...
This recommendation system consists of two services: `Generator` and `Invoker`. They are implemented using FastAPI framework, so you can use autogenerated docs to check how they work.
